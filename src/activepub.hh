...
public:
     ...
     */
    bool isScope;
    /**@brief Our Proposal for anycast
     * reverse FID, sub2pub FID*/
    BABitvector reverse_FID ;
    /**@brief anycast saving the pub2sub FID*/
    BABitvector incoming_FID ;
    /**brief anycast hop count*/
    unsigned char hop_count ;
    /**@brief indicates this content is from publisher or cache*/
    unsigned char origin ;
    /**@brief designates the # of publisher, in order to decide when to send the subinfo request*/
    int noofpub ;
    /**@brief this variable stores the nofiticationID of the publisher,
     * this variable will be used, if the origin is publisher*/
    ...
    /**@brief kanycast
     * this variable stores all the information IDs under the scope*/
    StringSet IIDs ;
    /**@brief kanycast
     * this variable designate the # of publisher*/
    int noofiipub ;
    /**@brief kanycast
     * this variable designate the # of received probing message*/
    int noofrcvpub ;
    /**@brief kanycast
     * map from informaion ID to FID, indicates each information item should be retrieved from which path*/
    HashTable<String, BABitvector> iid_FID_map ;
    /**@brief kanycast
     * map from information ID to an FID, the FID is from the pub to sub*/
    HashTable<String, BABitvector> iid_p2sFID ;
    /**@brief kanycast
     * map from information ID to distance*/
